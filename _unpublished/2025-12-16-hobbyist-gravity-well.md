---
title: The Hobbyist Maintainer Economic Gravity Well
---

In the OpenSource Supply Chain discourse in the past few years, we got multiple
...
usually really appreciated by the peanut gallery, which applaud making the Evil
Big Tech pays for the abuse they impose over their "exploitation of the
Commons".<!--more-->

Funnily enough, it seems nearly no-one sat down to ask if this could help the
...
On my previous post, [How FOSS Won and Why It
Matters](https://www.softwaremaxims.com/blog/how-foss-won-consequences), I
pointed out that forcing this kind of Commercial Supply Chain relationship on
FOSS would probably make it unusable for corporations.

But I barely talked of the other side of the equation. Would it help
maintainers? And why don't most hobbyist maintainers try to get this kind of
...
enough to make it a viable endeavour.

## The Income Level Needed

What I am going to talk about here is pretty "spherical cow". We are going to
...
So let's assume someone in NA or Western Europe, with a family, and an income of
something like 5k USD-or-equivalent monthly income post-tax. If we consider the
cost of a family, a car, housing, food, and the rest, they probably have some
leftover money, but not that much. There is some wiggle room if their partner
work, but we will still consider "5k per month" as our income level goal.

This is both really low and really high. From a "crowdsourced donation" point of
...
lot of work and really risky, and unrealistic". So we can forget this model as a
way to get the hobby out of the hobbyist maintainer with this model.

From a "get a stipend or funding by a government or charity" point of view,
...
in combination with other part time income stream". More about that in a bit.

But there are also stipends that do reach this income level. Sounds good right ?
...
keep this for last, because it is the more complex one.

## The Time Problem

The biggest problem when trying to justify being paid a full cost salary for
hobbyist maintainers is that a full time salary is, in a lot of the World,
considered equivalent to something around 38 to 40 hours of work per week. The
thing is, most hobbyist maintainer package do not have enough work to do to
...
What about Part-Time then? You work for commercial software most of the week,
...
Well yeah, duh. Let's start with the 6 months program of acceptable income, but
...
Except, that is not acceptable. Our maintainer has a mortgage or a rent to pay,
probably a loan on the family car, and other fixed costs. If the program end,
they will still need a stable income. So they would need to go on another grant
or find a new full-time employment. Here is the thing. And you will probably not
believe me, but please try.

Finding a new source of income as a software engineer take 6 months to a year of
...
is a really effed up process, which demand massive homework and learning for no
good reasons and is grueling on the mind.

Now, let's go back to the 6 months grant. Well. I leave a FTE job for a 6 months
grant, which I will need to spend finding a new FTE because I need income after
the 6 months. I am not sure that grant really helped me maintain my package.
Even if it is 12 months, 6 months in I need to be switching to searching for a
job if I have nothing yet. Because I cannot afford to not have income after that
grant ends.

And freelancing is comparable. If I want to leave my current FTE for
...
A few org will pay a fixed grant in order to implement a specific feature. This
can be a large grant over multiple years. Sounds good, right? Except there is a
...
Seems great, we don't want to spend our money on frivolous thing after all!
Except building that kind of case demands a lot of work and research, usually
over multiple years of building expertise, testing prototypes and maybe a mock
implementation. Then you need to write the whole grant demand, which is also
time consuming.

And that is time that will not be compensated and that usually hobbyists
...
investment in order of potentially getting a grant that it barely cover their
living expenses is not a realistic solution. They will simply not go to apply.
They can't afford it.

## So What? We Cannot Pay You?

Mostly, yeah, you cannot. Being a Full Time Software Engineer combined with a
...
they would fall back at the bottom of the gravity well.

You would need something like a 3 years program, at silicon valley level of
...
people doing things comparable in other charity areas. [McKenzie Scott comes to
mind](https://www.vox.com/future-perfect/470404/mackenzie-scott-amazon-trust-based-philanthropy-explained).

But she is definitely an exception. And this is why being a hobbyist maintainer
...
offer "solutions" to the hobbyist maintainer problem.
